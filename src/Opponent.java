...
class Opponent {
    ...
    public Opponent(boolean is_last, Pokemon player_pokemon) {
        ...
        if (is_last == false) {
            ...
            if (who == 0) {
                ...
                if (player_pokemon.Level < 4) {
                    try {
                        this.opponent_pokemon = new Pokemon("꼬리선", "노말", 1, 0, 2, 0, 2,
                ...
                if (player_pokemon.Level < 4) {
                    ...
                    try {
                        this.opponent_pokemon = new Pokemon("보만다", "드래곤", 5, 0, 15, 5, 5,
        ...
        // 마지막 날 상대하는 사람
        {
            ...
            try {
                this.opponent_pokemon = new Pokemon("디아루가", "드래곤", 20, 15, 15, 20, 10,
